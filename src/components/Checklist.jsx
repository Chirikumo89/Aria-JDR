      ...
      {contextMenu && createPortal(
        ...
        >
          ...
          <button
            ...
            disabled={disabled}
            className={`w-full px-4 py-2.5 text-left flex items-center gap-3 transition-colors text-gray-700 dark:text-gray-200 ${
              disabled ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer'
            }`}
          >
          ...
          {enableTransfer && onTransferItem && contextMenu.item.text && (
            <div className="relative">
              <button
                ...
                disabled={disabled}
                className={`w-full px-4 py-2.5 text-left flex items-center justify-between transition-colors text-blue-600 dark:text-blue-400 ${
                  disabled ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-50 dark:hover:bg-blue-900/30 cursor-pointer'
                }`}
              >
          ...
          <button
            ...
            disabled={disabled}
            className={`w-full px-4 py-2.5 text-left flex items-center gap-3 transition-colors text-red-600 dark:text-red-400 ${
              disabled ? 'opacity-50 cursor-not-allowed' : 'hover:bg-red-50 dark:hover:bg-red-900/30 cursor-pointer'
            }`}
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
